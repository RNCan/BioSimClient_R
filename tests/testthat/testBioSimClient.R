...
test_that("Testing degree-days between 2017 and 2021 under RCP 8.5 and climate model GCM4 for Quebec and Sorel can be properly retrieved", {
  ...
  expect_equal(abs(degreeDays[which(degreeDays$KeyID == "Sorel" & degreeDays$Year == 2019),"DD"] - 3266.15) < 1E-4, TRUE)
  expect_equal(abs(degreeDays[which(degreeDays$KeyID == "Sorel" & degreeDays$Year == 2020),"DD"] - 3539.65) < 1E-4, TRUE)
