...
monthlyMeans <- getMonthlyNormals("1981_2010", variables, locations$Name, locations$Latitude, locations$Longitude, locations$Elevation)
monthlyMeans

annualNormals <- getAnnualNormals("1981_2010", variables, locations$Name, locations$Latitude, locations$Longitude, locations$Elevation)
annualNormals
